...
//
// Debug information:
// Generated date: Sat Oct 21 04:35:13 PDT 2017
...
public class daily_stock extends SqoopRecord  implements DBWritable, Writable {
  ...
  public daily_stock with_updated_at(String updated_at) {
    this.updated_at = updated_at;
    return this;
  }
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.Date = JdbcWritableBridge.readTimestamp(1, __dbResults);
    this.Open = JdbcWritableBridge.readDouble(2, __dbResults);
    this.High = JdbcWritableBridge.readDouble(3, __dbResults);
    this.Low = JdbcWritableBridge.readDouble(4, __dbResults);
    this.Close = JdbcWritableBridge.readDouble(5, __dbResults);
    this.AdjClose = JdbcWritableBridge.readDouble(6, __dbResults);
    this.Volume = JdbcWritableBridge.readLong(7, __dbResults);
    this.tickt = JdbcWritableBridge.readString(8, __dbResults);
    this.updated_at = JdbcWritableBridge.readString(9, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    JdbcWritableBridge.writeTimestamp(Date, 1 + __off, 93, __dbStmt);
    JdbcWritableBridge.writeDouble(Open, 2 + __off, 8, __dbStmt);
    JdbcWritableBridge.writeDouble(High, 3 + __off, 8, __dbStmt);
    JdbcWritableBridge.writeDouble(Low, 4 + __off, 8, __dbStmt);
    JdbcWritableBridge.writeDouble(Close, 5 + __off, 8, __dbStmt);
    JdbcWritableBridge.writeDouble(AdjClose, 6 + __off, 8, __dbStmt);
    JdbcWritableBridge.writeLong(Volume, 7 + __off, -5, __dbStmt);
    JdbcWritableBridge.writeString(tickt, 8 + __off, -1, __dbStmt);
    JdbcWritableBridge.writeString(updated_at, 9 + __off, -1, __dbStmt);
    return 9;
  }
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    this.updated_at = Text.readString(__dataIn);
    }
  }
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.updated_at) { 
        ...
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, updated_at);
    }
  }
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    __cur_str = __it.next();
    if (__cur_str.equals("null")) { this.updated_at = null; } else {
      this.updated_at = __cur_str;
    }
